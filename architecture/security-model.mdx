...
All executions are permanently recorded on Kwala's decentralized ledger to enable audits and verification. You can use intent hashes, execution logs, and reports to verify historical workflow executions.
...
All nodes are vetted through the Kwala governance layer, with private keys stored in non-extractable Key Management Systems that perform signing operations in hardware enclaves.
