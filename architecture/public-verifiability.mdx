...
The [Kwala Explorer](https://explorer.kwala.network/) provides a user-friendly interface where you can:
...
<CardGroup cols={2}>
  ...
  <Card title="Kwala Explorer" icon="magnifying-glass" href="https://explorer.kwala.network/">
