...
description: 'Build an automated system that monitors wallet balances and automatically tops up low balances in real-time through smart contracts'
---
...
This setup enables self-sustaining wallets that stay funded without manual monithttps://kwala-1f7da9fb-document-use-cases.mintlify.app/oring.
...
With just two YAML workflows, we created an auto-rebalancing wallet system using Kwala Workflows without backend scripts, centralized orchestration, or manual intervention.
...
<CardGroup cols={2}>
  <Card title="Workflow Templates" icon="file-code" href="/concepts/workflow-templates">
