...
Contract Address (Polygon): `0x025B55313ac120435963f571F02EcC3d35FA6e6e`
...
- **Repeat Every:** event
- **Recurring Source Contract:** `0x60Fc086C786e8B66aeD0163A266bd3aF9125e8D0` (Treasury contract on Polygon)
- **Recurring Chain ID:** `137` (Polygon mainnet)
