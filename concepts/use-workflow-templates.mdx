...
| Multi-chain bridge monitor | Monitor cross-chain bridge transactions and get alerts when they complete | [View template](https://Kwala.network/templates/multi-chain-transaction-monitor) | [How-to guide](/use-cases/multi-chain-bridge-monitor) |
