...
The following example demonstrates a basic event-based trigger that monitors a smart contract on Polygon mainnet for `Transfer` events. Whenever tokens are transferred from the specified contract, this trigger will activate the workflow.
