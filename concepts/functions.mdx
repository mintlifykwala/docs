...
This workflow deploys the Kwala function logic onto the Kalp Chain. The Go contract evaluates token transfers and emits `TokenTransferEvaluated` events for high-value transactions.
