...
<Note>
**API triggers vs API actions.** This page covers API **actions** — outbound HTTP calls your workflow makes (`Type: post`) after it runs. If instead you want to **start** a workflow with an inbound HTTP request from a Web2 system, you want an API **trigger**. See [API triggers](/concepts/triggers#api-triggers-web2-triggers).
</Note>
