...
When configuring a token price trigger:
...
Exact price matches are not required. Kwala uses a configurable price range percentage for each token to evaluate trigger condition.
