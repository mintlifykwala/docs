...
|---------------|-------------|---------------|
| Token transfer alert | Monitor token transfers and get instant notifications when large amounts are moved | [View template](https://app.kwala.network/templates/token-transfer-alert) |
| DAO proposal notifier | Stay updated on DAO governance activities and never miss important votes | [View template](https://app.kwala.network/templates/dao-proposal-notifier) |
| NFT price tracker | Track NFT floor prices and receive notifications when they reach your target levels | [View template](https://app.kwala.network/templates/nft-price-tracker) |
| Multi-chain bridge monitor | Monitor cross-chain bridge transactions and get alerts when they complete | [View template](https://app.kwala.network/templates/multi-chain-bridge-monitor) |
| DeFi yield optimizer | Automatically optimize your DeFi portfolio by moving funds to the highest yielding protocols | [View template](https://app.kwala.network/templates/defi-yield-optimizer) |
| Liquidation protection | Protect your DeFi positions from liquidation by automatically monitoring collateral ratios | [View template](https://app.kwala.network/templates/liquidation-protection) |
...
<Steps>
  <Step title="Access templates">
    Navigate to the [templates page](https://app.kwala.network/templates) from your dashboard to explore available templates.
  </Step>
