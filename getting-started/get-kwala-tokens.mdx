...
There are two methods for purchasing Kwala credits using USDT on BNB Smart Chain. To get started, navigate to [payments page](https://payments.kwala.network/).
...
<Steps>
  <Step title="Connect your wallet">
    Visit [payments page](https://payments.kwala.network/) and select **Connect Wallet**. A pop up appears, where you select your wallet from the available options and approve the connection.
  <Frame>
  ...
  <Step title="Verify credit balance">
    ...
    <Frame>
      <img src="../images/getting-started/get-tokens/kwala-tokens-credited-new.png" alt="Kwala credits successfully credited to wallet" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Access payment portal">
    Visit [payments page](https://payments.kwala.network/) and select "Connect Wallet" to access the portal.
  </Step>
...
- Kwala deducts flat credits for workflow creation and trigger execution
...
Contact our [support team](/support/faq) for assistance with credits and billing.
