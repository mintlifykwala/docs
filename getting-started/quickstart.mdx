...
<Steps>
  <Step title="Open the Kwala payments page">
    Navigate to [payments page](https://payments.kwala.network/) to access the payment portal.
  </Step>
...
<CardGroup cols={2}>  
  <Card title="Learn to Create Workflow" icon="file-code" href="/workflow-builder/create-workflow">
    Learn to use Workflow Builder
  </Card>
