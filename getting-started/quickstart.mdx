...
<Steps>
  ...
  <Step title="Navigate to the Kwala dashboard"> 
    ...
    <Frame>
      <img src="/images/getting-started/quickstart/Kwala-dashboard-new.png" alt="Kwala dashboard interface" />
    </Frame>
  </Step>
...
<Steps>
  <Step title="Create new workflow">
    ...
    <Frame>
      <img src="/images/getting-started/quickstart/create-new-workflow-new.png" alt="Create new workflow button on dashboard" />
    </Frame>
  </Step>
  ...
  <Step title="Configure your workflow">
    ...
    <Frame>
      <img src="/images/getting-started/quickstart/kwala-workflow-builder-new.png" alt="Kwala workflow builder interface" />
    </Frame>
  ...
  <Step title="Review and edit your workflow">
    After saving, you can toggle into **YAML** from top where you can view and modify the generated YAML directly.

    <Frame>
      <img src="/images/getting-started/quickstart/kwala-workflow-editor-new.png" alt="Kwala workflow editor interface" />
    </Frame>
