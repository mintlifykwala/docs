...
<AccordionGroup>
  <Accordion title="Does Kwala require me to run my own server?">
    No. Kwala is fully serverless and runs your logic on Kwala's decentralized infrastructure. You can focus on building your dApp while Kwala handles execution, monitoring, and infrastructure.
  </Accordion>
