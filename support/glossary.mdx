...
### Kwala address
Unique identifier derived from your Wallet address, following the format: `KWL-{YourWalletAddress}-CC`. This address is used for credit management and workflow execution.
