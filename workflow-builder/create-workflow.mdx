...
<Steps>
  ...
  <Step title="Start a new workflow">
    ...
    <Frame>
      <img src="/images/workflow-builder/create-workflow/create-first-workflow-new.png" alt="New workflow button on the dashboard" />
    </Frame> 
  </Step>

  <Step title="Open the Workflow builder">
    You'll be redirected to the **Workflow Builder** UI.

    <Frame>
      <img src="/images/workflow-builder/create-workflow/select-workflow-builder-new.png" alt="Workflow Builder button in navigation" />
    </Frame>

    In this new window you can visually build your workflow step by step using the form-based UI.
  </Step>
  ...
  <Step title="Enter workflow information">
    ...
    <Frame>
      <img src="/images/workflow-builder/create-workflow/workflow-name-new.png" alt="Workflow name input" />
    </Frame>
  </Step>
  ...
  <Step title="Configure triggers and actions">
    ...
    <Frame>
      <img src="/images/workflow-builder/create-workflow/configure-triggers-new.png" alt="Trigger and action configuration" />
    </Frame>
