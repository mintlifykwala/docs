...
<Frame>
  <img src="/images/workflow-builder/monitor-workflow/my-workflows-dashboard-new.png" alt="My workflows dashboard" />
</Frame>
...
<Frame>
  <img src="/images/workflow-builder/monitor-workflow/successful-actions-metadata-new.png" alt="Successful actions tab" />
</Frame>
...
Select the workflow you want to monitor, then click on **YAML** toggle. The workflow Info pane displays the current status of your workflow.

<Frame>
  <img src="/images/workflow-builder/monitor-workflow/workflow-information-pane-new.png" alt="Workflow details pane" />
</Frame>
...
You can also monitor your workflows using the [Kwala Explorer](https://explorer.kwala.network/). The Explorer provides an alternative view of your workflow activity and execution history.

To view your workflows in the Explorer:

1. Navigate to [Kwala Explorer](https://explorer.kwala.network/)
