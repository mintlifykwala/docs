...
```yaml
  - Name: telg1
    ...
    APIPayload:
      chat_id: '968602918'           # fixed value
      text: Hi re.event(1), your certificate ID re.event(2) is credited on your wallet address re.event(0).   # mixed: text + event parameters
